A Mainboard represents a physical mainboard asset, which is either in use and assigned to a device, or an available spare and assigned to a storage location.

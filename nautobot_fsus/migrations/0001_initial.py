            ...
            fields=[
                ...
                (
                    ...
                    StatusField(
                        null=True,
                        on_delete=deletion.PROTECT,
                        related_name='nautobot_fsus_mainboard_related',
                        to='extras.status',
                    ),
                ),
                ('tags', TaggableManager(through='extras.TaggedItem', to='extras.Tag')),
            ...
            fields=[
                ...
                (
                    ...
                    StatusField(
                        null=True,
                        on_delete=deletion.PROTECT,
                        related_name='nautobot_fsus_hba_related',
                        to='extras.status',
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=deletion.PROTECT,
                        related_name='gpubaseboardtypes',
                        to='dcim.manufacturer',
                    ),
                ),
            ...
            fields=[
                ...
                (
                    ...
                    StatusField(
                        null=True,
                        on_delete=deletion.PROTECT,
                        related_name='nautobot_fsus_gpubaseboard_related',
                        to='extras.status',
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=deletion.CASCADE,
                        related_name='rammoduletemplates',
                        to='dcim.devicetype',
                    ),
                ),
                (
            ...
            fields=[
                ...
                (
                    ...
                    StatusField(
                        null=True,
                        on_delete=deletion.PROTECT,
                        related_name='nautobot_fsus_rammodule_related',
                        to='extras.status',
                    ),
                ),
                ('tags', TaggableManager(through='extras.TaggedItem', to='extras.Tag')),
            ...
            fields=[
                ...
                (
                    'status', StatusField(
                        null=True,
                        on_delete=deletion.PROTECT,
                        related_name='nautobot_fsus_psu_related',
                        to='extras.status',
                    ),
                ),
                ('tags', TaggableManager(through='extras.TaggedItem', to='extras.Tag')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=deletion.CASCADE,
                        related_name='otherfsutemplates',
                        to='dcim.devicetype',
                    ),
                ),
                (
            ...
            fields=[
                ...
                (
                    ...
                    StatusField(
                        null=True,
                        on_delete=deletion.PROTECT,
                        related_name='nautobot_fsus_otherfsu_related',
                        to='extras.status',
                    ),
                ),
                ('tags', TaggableManager(through='extras.TaggedItem', to='extras.Tag')),
            ...
            fields=[
                ...
                (
                    ...
                    StatusField(
                        null=True,
                        on_delete=deletion.PROTECT,
                        related_name='nautobot_fsus_nic_related',
                        to='extras.status',
                    ),
                ),
                ('tags', TaggableManager(through='extras.TaggedItem', to='extras.Tag')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=deletion.CASCADE,
                        related_name='mainboardtemplates',
                        to='dcim.devicetype',
                    ),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=deletion.CASCADE,
                        related_name='gpubaseboardtemplates',
                        to='dcim.devicetype',
                    ),
                ),
                (
            ...
            fields=[
                ...
                (
                    ...
                    StatusField(
                        null=True,
                        on_delete=deletion.PROTECT,
                        related_name='nautobot_fsus_gpu_related',
                        to='extras.status',
                    ),
                ),
                ('tags', TaggableManager(through='extras.TaggedItem', to='extras.Tag')),
            ...
            fields=[
                ...
                (
                    ...
                    StatusField(
                        null=True,
                        on_delete=deletion.PROTECT,
                        related_name='nautobot_fsus_fan_related',
                        to='extras.status',
                    ),
                ),
                ('tags', TaggableManager(through='extras.TaggedItem', to='extras.Tag')),
            ...
            fields=[
                ...
                (
                    ...
                    StatusField(
                        null=True,
                        on_delete=deletion.PROTECT,
                        related_name='nautobot_fsus_disk_related',
                        to='extras.status',
                    ),
                ),
                ('tags', TaggableManager(through='extras.TaggedItem', to='extras.Tag')),
            ...
            fields=[
                ...
                (
                    ...
                    StatusField(
                        null=True,
                        on_delete=deletion.PROTECT,
                        related_name='nautobot_fsus_cpu_related',
                        to='extras.status',
                    ),
                ),
                ('tags', TaggableManager(through='extras.TaggedItem', to='extras.Tag')),
